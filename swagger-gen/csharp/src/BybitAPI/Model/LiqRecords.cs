...
namespace BybitAPI.Model
{
    ...
    public partial class LiqRecords : IEquatable<LiqRecords>, IValidatableObject
    {
        ...
        public LiqRecords(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<LiqRecordsInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LiqRecords);
