...
namespace BybitAPI.Model
{
    ...
    public partial class LinearOrderCancelAllBase : IEquatable<LinearOrderCancelAllBase>, IValidatableObject
    {
        ...
        public LinearOrderCancelAllBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<string> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LinearOrderCancelAllBase);
