...
namespace BybitAPI.Model
{
    ...
    public partial class LinearRecentTradingRecordResp : IEquatable<LinearRecentTradingRecordResp>, IValidatableObject
    {
        ...
        public LinearRecentTradingRecordResp(string id = default, double? price = default, double? qty = default, string side = default, string symbol = default, string time = default, long? tradeTimeMs = default)
        {
            Id = id;
            Price = price;
            Qty = qty;
        ...
        public override bool Equals(object input) => Equals(input as LinearRecentTradingRecordResp);
