...
namespace BybitAPI.Model
{
    ...
    public partial class LinearSetTradingStopResult : IEquatable<LinearSetTradingStopResult>, IValidatableObject
    {
        ...
        public LinearSetTradingStopResult(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LinearSetTradingStopResult);
