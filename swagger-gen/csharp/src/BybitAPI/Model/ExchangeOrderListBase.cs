...
namespace BybitAPI.Model
{
    ...
    public partial class ExchangeOrderListBase : IEquatable<ExchangeOrderListBase>, IValidatableObject
    {
        ...
        public ExchangeOrderListBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<ExchangeOrderList> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as ExchangeOrderListBase);
