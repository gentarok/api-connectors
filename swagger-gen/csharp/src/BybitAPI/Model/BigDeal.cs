...
namespace BybitAPI.Model
{
    ...
    public partial class BigDeal : IEquatable<BigDeal>, IValidatableObject
    {
        ...
        public BigDeal(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<BigDealInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as BigDeal);
