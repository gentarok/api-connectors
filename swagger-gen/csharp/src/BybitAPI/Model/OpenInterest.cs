...
namespace BybitAPI.Model
{
    ...
    public partial class OpenInterest : IEquatable<OpenInterest>, IValidatableObject
    {
        ...
        public OpenInterest(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<OpenInterestInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as OpenInterest);
