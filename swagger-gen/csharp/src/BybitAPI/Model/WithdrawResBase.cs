...
namespace BybitAPI.Model
{
    ...
    public partial class WithdrawResBase : IEquatable<WithdrawResBase>, IValidatableObject
    {
        ...
        public WithdrawResBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<WithdrawRecords> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as WithdrawResBase);
