...
namespace BybitAPI.Model
{
    ...
    public partial class LinearTradeRecordsResponse : IEquatable<LinearTradeRecordsResponse>, IValidatableObject
    {
        ...
        public LinearTradeRecordsResponse(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<LinearTradeRecordItem> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LinearTradeRecordsResponse);
