...
namespace BybitAPI.Model
{
    ...
    public partial class TradingRecords : IEquatable<TradingRecords>, IValidatableObject
    {
        ...
        public TradingRecords(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<TradingRecordsInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as TradingRecords);
