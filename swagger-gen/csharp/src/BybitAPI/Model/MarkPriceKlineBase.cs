...
namespace BybitAPI.Model
{
    ...
    public partial class MarkPriceKlineBase : IEquatable<MarkPriceKlineBase>, IValidatableObject
    {
        ...
        public MarkPriceKlineBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<MarkPriceKlineInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as MarkPriceKlineBase);
