...
namespace BybitAPI.Model
{
    ...
    public partial class FundingPredicted : IEquatable<FundingPredicted>, IValidatableObject
    {
        ...
        public FundingPredicted(double? predictedFundingRate = default, double? predictedFundingFee = default)
        {
        ...
        public override bool Equals(object input) => Equals(input as FundingPredicted);
