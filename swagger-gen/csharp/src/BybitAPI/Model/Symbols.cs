...
namespace BybitAPI.Model
{
    ...
    public partial class Symbols : IEquatable<Symbols>, IValidatableObject
    {
        ...
        public Symbols(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<SymbolInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as Symbols);
