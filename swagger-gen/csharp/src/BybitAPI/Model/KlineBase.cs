...
namespace BybitAPI.Model
{
    ...
    public partial class KlineBase : IEquatable<KlineBase>, IValidatableObject
    {
        ...
        public KlineBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<KlineRes> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as KlineBase);
