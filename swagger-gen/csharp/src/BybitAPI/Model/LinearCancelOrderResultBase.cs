...
namespace BybitAPI.Model
{
    ...
    public partial class LinearCancelOrderResultBase : IEquatable<LinearCancelOrderResultBase>, IValidatableObject
    {
        ...
        public LinearCancelOrderResultBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, object result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LinearCancelOrderResultBase);
