...
namespace BybitAPI.Model
{
    ...
    public partial class LinearOrderRecordsResponseBase : IEquatable<LinearOrderRecordsResponseBase>, IValidatableObject
    {
        ...
        public LinearOrderRecordsResponseBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, object result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LinearOrderRecordsResponseBase);
