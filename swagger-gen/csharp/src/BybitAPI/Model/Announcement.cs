...
namespace BybitAPI.Model
{
    ...
    public partial class Announcement : IEquatable<Announcement>, IValidatableObject
    {
        ...
        public Announcement(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<AnnouncementInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as Announcement);
