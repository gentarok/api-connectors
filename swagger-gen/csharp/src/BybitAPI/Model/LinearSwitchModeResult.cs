...
namespace BybitAPI.Model
{
    ...
    public partial class LinearSwitchModeResult : IEquatable<LinearSwitchModeResult>, IValidatableObject
    {
        ...
        public LinearSwitchModeResult(double? tpSlMode = default) => TpSlMode = tpSlMode;
        ...
        public override bool Equals(object input) => Equals(input as LinearSwitchModeResult);
