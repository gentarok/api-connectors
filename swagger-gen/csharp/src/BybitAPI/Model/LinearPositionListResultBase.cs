...
namespace BybitAPI.Model
{
    ...
    public partial class LinearPositionListResultBase : IEquatable<LinearPositionListResultBase>, IValidatableObject
    {
        ...
        public LinearPositionListResultBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<LinearPositionListResult> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as LinearPositionListResultBase);
