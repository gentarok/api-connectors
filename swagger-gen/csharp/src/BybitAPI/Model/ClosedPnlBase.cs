...
namespace BybitAPI.Model
{
    ...
    public partial class ClosedPnlBase : IEquatable<ClosedPnlBase>, IValidatableObject
    {
        ...
        public ClosedPnlBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<ClosedPnlInfo> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as ClosedPnlBase);
