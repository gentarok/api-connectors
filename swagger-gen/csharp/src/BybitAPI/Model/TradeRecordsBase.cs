...
namespace BybitAPI.Model
{
    ...
    public partial class TradeRecordsBase : IEquatable<TradeRecordsBase>, IValidatableObject
    {
        ...
        public TradeRecordsBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<TradeRecords> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as TradeRecordsBase);
