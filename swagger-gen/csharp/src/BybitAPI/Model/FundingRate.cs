...
namespace BybitAPI.Model
{
    ...
    public partial class FundingRate : IEquatable<FundingRate>, IValidatableObject
    {
        ...
        public FundingRate(string symbol = default, string fundingRate = default, decimal? fundingRateTimestamp = default)
        {
            Symbol = symbol;
        ...
        public override bool Equals(object input) => Equals(input as FundingRate);
