...
namespace BybitAPI.Model
{
    ...
    public partial class ConditionalOrdersResBase : IEquatable<ConditionalOrdersResBase>, IValidatableObject
    {
        ...
        public ConditionalOrdersResBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<ConditionalOrdersRes> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as ConditionalOrdersResBase);
