...
namespace BybitAPI.Model
{
    ...
    public partial class GetRiskLimitRes : IEquatable<GetRiskLimitRes>, IValidatableObject
    {
        ...
        public GetRiskLimitRes(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, List<RiskIDRes> result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as GetRiskLimitRes);
