...
namespace BybitAPI.Model
{
    ...
    public partial class OrderCancelBase : IEquatable<OrderCancelBase>, IValidatableObject
    {
        ...
        public OrderCancelBase(decimal? retCode = default, string retMsg = default, string extCode = default, string extInfo = default, OrderRes result = default, string timeNow = default)
        {
            RetCode = retCode;
            RetMsg = retMsg;
            ExtCode = extCode;
        ...
        public override bool Equals(object input) => Equals(input as OrderCancelBase);
