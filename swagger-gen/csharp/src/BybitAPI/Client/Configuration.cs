...
namespace BybitAPI.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        private IDictionary<string, string> _apiKey = new ConcurrentDictionary<string, string>();

        /// <summary>
        /// Gets or sets the prefix (e.g. Token) of the API key based on the authentication name.
        /// </summary>
        /// <value>The prefix of the API key.</value>
        private IDictionary<string, string> _apiKeyPrefix = new ConcurrentDictionary<string, string>();
        ...
        /// </summary>
        public virtual IDictionary<string, string> DefaultHeader { get; set; } = new ConcurrentDictionary<string, string>();
